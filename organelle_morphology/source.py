...
class DataSource:
    ...
    def organelles(
        self, ids: str = "*", return_ids: bool = False, permanent_filter=None
        ...
        if permanent_filter is not None:
            filtered_ids = [
                org_id for org_id in filtered_ids if org_id not in permanent_filter
            ]
