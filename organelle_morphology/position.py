...
class Position_Analysis(Analysis):
    ...
    def density3D(
        ...
        """Calculate a 3d heatmap of all

        Args:
            organelle: For which organelle to create the heatmap
            bin_resolution: resolution of the binning in micrometer.
        """
